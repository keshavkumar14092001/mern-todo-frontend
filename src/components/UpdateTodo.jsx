...
import { getSingleTodo, updateTodo } from "../api/helper";
...
const UpdateTodo = () => {
  ...
  return (
    <section className="flex items-center justify-center h-screen w-full todoContainer">
